...
export const LESSONS: Lesson[] = [
  { id: 'meet', number: '01', title: 'Meet your MPK', eyebrow: 'Start here', description: 'Get comfortable with every control, then make the keyboard yours.', minutes: 8, steps: [
    ...
    { id: 'hard-key', title: 'Now give it some weight', instruction: 'Play a key firmly so you can feel how touch changes the sound.', goal: { type: 'event', match: { kind: 'key', minVelocity: .85 } } },
    { id: 'any-pad', title: 'Meet the pads', instruction: 'Tap any red pad. A stronger hit makes a brighter, louder drum.', goal: { type: 'event', match: { kind: 'pad' } } },
    ...
    { id: 'joy', title: 'Move the joystick', instruction: 'Lean the joystick left or right. It bends a note the way a guitarist bends a string.', goal: { type: 'event', match: { kind: 'joyX' } } },
    recap('meet-recap', 'You know the whole surface', ['Keys respond to your touch.', 'Pads play your drum kit.', 'Knobs and the joystick shape sound.']),
  ]},
