...
function SynthPanel() {
  const knobs = useMidiStore((s) => s.knobValues); const [preset, choose] = useState<keyof typeof SYNTH_PRESETS | 'Custom'>('Warm Pad'); const names = ['Brightness', 'Resonance', 'Release', 'Echo send', 'Attack', '—', 'Echo time', 'Feedback']
