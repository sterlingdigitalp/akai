...
type UiState = { view: View; activeLessonId: string | null; playgroundTab: 'synth' | 'beats' | 'takes'; go: (view: View) => void; openLesson: (id: string) => void; setPlaygroundTab: (tab: 'synth' | 'beats' | 'takes') => void }
